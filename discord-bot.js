...
const bot = new Eris(
  "ODQ3MTI4OTc1Mzc2Nzc3MjE2.YK5kVg.dXmGpumFD3m4zUN83nViZjJEqGg"
);
...
const createNewChannel = async (game, member) => {
  try {
    const newChannel = await bot.createChannel(GUILD_ID, `${game.color} ${game.name}`, 2, {
      nsfw: false,
